        ...
        <div class="position-relative z-1 d-flex justify-content-between align-items-end">
            <div>
                <div class="d-flex align-items-center gap-3 mb-4">
                    <span class="badge bg-success bg-opacity-10 text-success uppercase-bold px-3 py-2 border border-success border-opacity-20">Resident Portal</span>
                    <span class="text-white-50 small">Profile & Security Hub</span>
                </div>
                <h1 class="display-3 fw-bold text-white tracking-tighter mb-3">Portal <span class="text-info">Settings</span></h1>
                <p class="text-white-50 lead mb-0" style="max-width: 600px;">Managing your personal identity, security protocols, and communication triggers.</p>
            </div>
            <button class="btn btn-info px-4 py-3 rounded-pill fw-bold shadow-lg d-none d-md-block" onclick="saveSettings()">
                ...
                <div class="glass-card-premium rounded-5 p-4 mb-4">
                    ...
                    <div class="d-flex align-items-center gap-4 mb-5 pb-4 border-bottom border-white">
                        <div class="avatar-upload-premium">
                            <div class="avatar-img bg-primary-navy d-flex align-items-center justify-content-center text-white display-6 fw-bold">SR</div>
                        ...
                        <div>
                            ...
                            <button class="btn btn-sm btn-white border rounded-pill px-3 extra-small fw-bold">UPDATE PHOTO</button>
                        </div>
                    </div>
                    ...
                    <div class="row g-4">
                        ...
                        <div class="col-12">
                            ...
                            <input type="text" class="form-control geist-input-premium" value="TechCorp Bangladesh Ltd.">
                        </div>
                    </div>
                </div>
        ...
        <div class="row g-4">
                ...
                <div class="glass-card-premium rounded-5 p-4 mb-4">
                    ...
                    <div class="row g-4">
                        ...
                        <div class="col-md-6">
                            ...
                            <input type="password" class="form-control geist-input-premium" placeholder="Generate new secret">
                        </div>
                        <div class="col-md-6">
                            <label class="uppercase-bold text-muted mb-2 d-block opacity-60">Confirm New Key</label>
                            <input type="password" class="form-control geist-input-premium" placeholder="Verify new secret">
                        </div>
                        <div class="col-12">
                            <button class="btn btn-primary-navy px-5 py-3 rounded-pill fw-bold">ROTATE SECURITY KEYS</button>
                        </div>
                    </div>
                </div>
            </div>
            <div class="col-lg-4">
                <div class="glass-card-premium rounded-5 p-4 border-danger border-opacity-20">
                    ...
                    <p class="extra-small text-muted mb-4">Permanent truncation of your resident identity and data history.</p>
