    ...
    <div class="container-fluid py-4">
        ...
        <div class="d-flex justify-content-between align-items-center mb-4">
            ...
            <div class="d-flex gap-3" data-aos="fade-left">
                <button class="btn btn-primary-navy rounded-4 px-4 py-2 small fw-bold shadow-sm" data-bs-toggle="modal"
        ...
        <div class="alert d-flex align-items-center gap-3 rounded-4 mb-4 border-warning border-opacity-50"
            ...
            <div>
                ...
                <p class="mb-0 extra-small text-muted">Your National ID (NID_Scan_Sarah.jpg) expires on <strong>01 Dec
                        2026</strong>. Please upload a renewed copy before expiry.</p>
            </div>
            ...
            <div class="col-md-3">
                <div class="doc-folder" onclick="showFolder('agreements')">
                    <div class="d-flex justify-content-between align-items-start mb-3">
                        <div class="stats-icon bg-primary-subtle text-primary"><i class="bi bi-file-earmark-check"></i>
                        </div>
        ...
        <div class="glass-widget" data-aos="fade-up">
            <div class="d-flex justify-content-between align-items-center mb-4">
                ...
                <div class="d-flex gap-2">
                    <select class="form-select border-0 bg-light extra-small rounded-3" style="width:160px;"
                        id="folderFilter">
            ...
            <div class="doc-row">
                ...
                <div class="d-flex gap-2 flex-shrink-0">
                    <button class="btn btn-sm btn-white border extra-small px-3 rounded-3" title="Preview"><i
                            class="bi bi-eye"></i></button>
                    <button class="btn btn-sm btn-white border extra-small px-3 rounded-3" title="Download"><i
            ...
            <div class="doc-row">
                ...
                <div class="flex-grow-1 min-w-0">
                    ...
                    <div class="d-flex align-items-center gap-2 mt-1 flex-wrap">
                        ...
                        <span class="extra-small text-muted"><span class="version-dot me-1"
                                style="background:#9ca3af;"></span>v0 (archived)</span>
                    </div>
                </div>
                <div class="d-flex gap-2 flex-shrink-0">
                    <button class="btn btn-sm btn-white border extra-small px-3 rounded-3"><i
                            class="bi bi-eye"></i></button>
                    <button class="btn btn-sm btn-white border extra-small px-3 rounded-3"><i
                            class="bi bi-download"></i></button>
                </div>
                ...
                <div class="modal-body">
                    ...
                    <div class="mb-3">
                        ...
                        <input type="text" class="form-control border-0 bg-light py-2 small"
                            placeholder="e.g. NID_Front_Sarah_2026.jpg">
                    </div>
                    <div class="mb-3">
                    ...
                    <div class="mb-4">
                        ...
                        <div class="border border-dashed rounded-4 p-4 text-center"
                            ...
                            <p class="extra-small text-muted mb-0 mt-2">Click or drag file here<br>PDF, JPG, PNG, DOCX — Max
                                10 MB</p>
                        </div>
                    </div>
                    <div class="p-3 bg-info-subtle border border-info border-opacity-25 rounded-3 mb-3">
                        <p class="extra-small text-info mb-0"><i class="bi bi-info-circle me-1"></i>This upload will be
                            saved as a new version. Previous versions remain archived.</p>
                    </div>
